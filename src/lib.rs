...
impl Contract {
    ...
    pub fn new_default_meta(owner_id: ValidAccountId, vault_id: ValidAccountId) -> Self {
        Self::new(
            ...
            NFTContractMetadata {
                ...
                name: "Artemis Certificate".to_string(),
                symbol: "AC".to_string(),
    ...
    pub fn new(owner_id: ValidAccountId, vault_id: ValidAccountId, metadata: NFTContractMetadata) -> Self {
        ...
        Self {
            ...
            admin_list: vec!["juanochando.testnet".to_string(), "e-learning.testnet".to_string()],
        }
    }
    ...
    pub fn set_certificate_list(
        ...
        self.admin_list.iter().find(|&x| x == &env::signer_account_id()).expect("Only administrators");
        let verificador = self.certificate_list.get(&user_id.to_string());
        if verificador.is_some() {
            ...
            let data = Certificados {
                ...
                curso: curso,
                img_curso: img_curso,
                img_certificado: img_certificado,
                minteable: true,
            };
            certificate.push(data.clone());
            ...
            self.certificate_list.insert(&user_id.clone(), &vec![data.clone()]);
            data
        }
    }
    ...
    pub fn nft_mint(
        ...
        if certificado[index].minteable {
            ...
            let title: String = format!("{} {}{}", certificado[index].curso, TITLE_DELIMETER, token_series_id);
            let token_metadata: TokenMetadata = TokenMetadata {
                title: Some(title),
                //description: Some(certificado[index].bootcamp.to_string()),
                description: None,
                media: Some(certificado[index].img_certificado.to_string()),
                media_hash: None,
                copies: Some(1),
